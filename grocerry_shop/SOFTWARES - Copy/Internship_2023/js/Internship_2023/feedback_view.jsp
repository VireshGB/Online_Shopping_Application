...
<div class="container-fluid p-3 mt-1">
   <div class="row">
      ...
      <h1 class="text-success"> feedback details </h1>
...
%>
            <tr>
                ...
                <td><a href="feedback_del.jsp?id=<%=res.getString(1)%>"> delete </a> </td> 
                <td><a href="feedback_edit.jsp?id=<%=res.getString(1)%>">edit </a> </td>   
