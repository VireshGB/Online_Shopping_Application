...
<div class="container-fluid p-3 mt-1">
   <div class="row">
      ...
      <h1 class="text-success"> category details </h1>
...
%>
            <tr>
                ...
                <td><a href="category_del.jsp?id=<%=res.getString(1)%>"> delete </a> </td> 
                <td><a href="category_edit.jsp?id=<%=res.getString(1)%>">edit </a> </td> 
